...
//Fixed or long term assets Handlers
  ...
  handleInputFormSubmit(event){
    ...
    superagent
      ...
      .send({entry_type: 'actual',period_sales: this.state.totalEarnedRevenue, cogs: this.state.costOfGoodsSold, marketing: this.state.marketing,    direct_labor: this.state.directLabor, distribution: this.state.distribution, salaries: this.state.salaries, benefit_admin:  this.state.benefits, office_lease: this.state.office, office_supplies: this.state.officeSupplies,
