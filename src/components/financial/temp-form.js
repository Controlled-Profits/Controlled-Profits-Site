  ...
  handleInputFormSubmit(event){
    ...
    superagent
      ...
      .set({"Access-Token": accessToken, "Client": client, "Token-Type": tokenType, "Uid": uid})
        .send({period_sales: this.state.totalEarnedRevenue, cogs: this.state.costOfGoodsSold, marketing: this.state.marketing, direct_labor: this.state.directLabor, distribution: this.state.distribution, salaries: this.state.salaries, benefit_admin: this.state.benefits, office_lease: this.state.office, office_supplies: this.state.officeSupplies,
        ...
        <form onSubmit={this.handleInputFormSubmit.bind(this)}>
          ...
          <div className='input-title-container'>
            ...
            <div className="input-group financial-input">
              ...
              <input type="text" className="form-control" onChange={this.handleTOEChange.bind(this)} value={this.state.totalEarnedRevenue} placeholder='0.00'/>
            </div>
          ...
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleCOGSChange.bind(this)} value={this.state.costOfGoodsSold} placeholder='0.00'/>
              </div>
              {/* Marketing */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Marketing</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleMarketingChange.bind(this)} value={this.state.marketing} placeholder='0.00'/>
              </div>
              {/* Direct Labor */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Direct Labor</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleDirectLaborChange.bind(this)} value={this.state.directLabor} placeholder='0.00'/>
              </div>
              {/* Distribution */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Distribution</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleDistroChange.bind(this)} value={this.state.distribution} placeholder='0.00'/>
              </div>
          ...
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleSalariesChange.bind(this)} value={this.state.salaries} placeholder='0.00'/>
              </div>
              {/* Benefits */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Benefit Admin (payroll services, contributions, etc)</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleBenefitsChange.bind(this)} value={this.state.benefits} placeholder='0.00'/>
              </div>
              {/* Office */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Office Lease/Rent</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOfficeChange.bind(this)} value={this.state.office} placeholder='0.00'/>
              </div>
              {/* Office Supplies */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Office Supplies</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOfficeSuppliesChange.bind(this)} value={this.state.officeSupplies} placeholder='0.00'/>
              </div>
              {/* Utilities */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Utilities</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleUtilitiesChange.bind(this)} value={this.state.utilities} placeholder='0.00'/>
              </div>
              {/* Transportation */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Transportation</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleTransportationChange.bind(this)} value={this.state.transportation} placeholder='0.00'/>
              </div>
              {/* OnlineExp */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Online Expenses</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOnlineExpChange.bind(this)} value={this.state.onlineExp} placeholder='0.00'/>
              </div>
              {/* insurance */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Insurance</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleInsuranceChange.bind(this)} value={this.state.insurance} placeholder='0.00'/>
              </div>
              {/* Training */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Training</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleTrainingChange.bind(this)} value={this.state.training} placeholder='0.00'/>
              </div>
              {/* Accounting And Legal */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Accounting & Legal</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleAccountAndLegalChange.bind(this)} value={this.state.accountAndLegal} placeholder='0.00'/>
              </div>
              {/* Ads */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Advertising</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleAdsChange.bind(this)} value={this.state.ads} placeholder='0.00'/>
              </div>
              {/* Marketing Development */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Marketing Development</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleMarketingDevChange.bind(this)} value={this.state.marketingDev} placeholder='0.00'/>
              </div>
              {/* Other */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Other (Repairs, Maintenance, Furniture)</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOtherChange.bind(this)} value={this.state.other} placeholder='0.00'/>
              </div>
              {/* Interest Paid */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Interest Paid</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleIntPaidChange.bind(this)} value={this.state.intPaid} placeholder='0.00'/>
              </div>
              {/* Donations */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Donations</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleDonationsChange.bind(this)} value={this.state.donations} placeholder='0.00'/>
              </div>
              {/* Depreciation & Amortization */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Depreciation & Amortization</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleDepreciationAndAmortizationChange.bind(this)} value={this.state.depreciationAndAmortization} placeholder='0.00'/>
              </div>
              {/* TaxRate */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Tax Rate</label>
                <input type="text" className="form-control" onChange={this.handleTaxRateChange.bind(this)} value={this.state.taxRate} placeholder='0.00'/>
                <span className="input-group-addon">%</span>
              </div>
            </div>
            <hr/>
          ...
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleCashChange.bind(this)} value={this.state.cash} placeholder='0.00'/>
              </div>
              {/* Accounts Receivable */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Accounts Receivable</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleAccountsReceivableChange.bind(this)} value={this.state.accountsReceivable} placeholder='0.00'/>
              </div>
              {/* Inventory */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Inventory</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleInventoryChange.bind(this)} value={this.state.inventory} placeholder='0.00'/>
              </div>
              {/* prepaid Expenses */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Prepaid Expenses</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handlePrepaidExpensesChange.bind(this)} value={this.state.prepaidExpenses} placeholder='0.00'/>
              </div>
              {/* other Current Assets */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Other Current Assets</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOtherCurrentAssetsChange.bind(this)} value={this.state.otherCurrentAssets} placeholder='0.00'/>
              </div>
            </div>
            <hr/>
          </div>
          ...
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handlePropertyPlantEquipmentChange.bind(this)} value={this.state.propertyPlantEquipment} placeholder='0.00'/>
              </div>
              {/* Furniture & Fixtures */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Furniture & Fixtures</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleFurnitureFixturesChange.bind(this)} value={this.state.furnitureFixtures} placeholder='0.00'/>
              </div>
              {/* Leasehold Improvements */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Leasehold Improvements</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleLeaseholdImprovementsChange.bind(this)} value={this.state.leaseholdImprovements} placeholder='0.00'/>
              </div>
              {/* Land & Building */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Land & Building</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleLandBuildingChange.bind(this)} value={this.state.landBuilding} placeholder='0.00'/>
              </div>
              {/* Other Fixed Assets */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Other Fixed Assets</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOtherFixedAssetsChange.bind(this)} value={this.state.otherFixedAssets} placeholder='0.00'/>
              </div>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleAccumulatedDepreciationChange.bind(this)} value={this.state.accumulatedDepreciation} placeholder='0.00'/>
              </div>
              {/* GoodWill */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Goodwill</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleGoodwillChange.bind(this)} value={this.state.goodwill} placeholder='0.00'/>
              </div>
            </div>
            <hr/>
          </div>
          ...
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleAccountsPayableChange.bind(this)} value={this.state.accountsPayable} placeholder='0.00'/>
              </div>
              {/* Interest Payable */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Interest Payable</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleInterestPayableChange.bind(this)} value={this.state.interestPayable} placeholder='0.00'/>
              </div>
              {/* Taxes Payable */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Taxes Payable</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleTaxesPayableChange.bind(this)} value={this.state.taxesPayable} placeholder='0.00'/>
              </div>
              {/* Deferred Revenue */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Deferred Revenue</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleDeferredRevenueChange.bind(this)} value={this.state.deferredRevenue} placeholder='0.00'/>
              </div>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleShortTermNotesChange.bind(this)} value={this.state.shortTermNotes} placeholder='0.00'/>
              </div>
              {/* Current Part, Long Term Debt */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Current Part, Long Term Debt</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleCurrentPartLongTermDebtChange.bind(this)} value={this.state.currentPartLongTermDebt} placeholder='0.00'/>
              </div>
              {/* Current Liabilities  */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Current Liabilities </label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleCurrentLiabilitiesChange.bind(this)} value={this.state.currentLiabilities} placeholder='0.00'/>
              </div>
            </div>
            <hr/>
          </div>
          ...
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleBankLoansPayableChange.bind(this)} value={this.state.bankLoansPayable} placeholder='0.00'/>
              </div>
              {/* Notes payable to Stockholders */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Notes payable to Stockholders</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleNotesPayableToStockholdersChange.bind(this)} value={this.state.notesPayableToStockholders} placeholder='0.00'/>
              </div>
              {/* Other Long Term Debt */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Other Long Term Debt</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleOtherLongTermDebtChange.bind(this)} value={this.state.otherLongTermDebt} placeholder='0.00'/>
              </div>
            </div>
            <hr/>
          </div>
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleCommonStockChange.bind(this)} value={this.state.commonStock} placeholder='0.00'/>
              </div>
              {/* Paid-In Surplus */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Paid-In Surplus</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handlePaidInSurplusChange.bind(this)} value={this.state.paidInSurplus} placeholder='0.00'/>
              </div>
              {/* Retained Earnings */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Retained Earnings</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleRetainedEarningsChange.bind(this)} value={this.state.retainedEarnings} placeholder='0.00'/>
              </div>
            </div>
            <hr/>
          </div>
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleProspectsLeadsChange.bind(this)} value={this.state.prospectsLeads} placeholder='0.00'/>
              </div>
              {/* Number of Sales (Receipts) */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Number of Sales (Receipts)</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleNumOfSalesRecChange.bind(this)} value={this.state.numOfSalesRec} placeholder='0.00'/>
              </div>
              {/* Marketing Spend (Direct -from P&L) */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Marketing Spend (Direct -from P&L)</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleMarketingSpentChange.bind(this)} value={this.state.marketingSpent} placeholder='0.00'/>
              </div>
              {/* Grand Total Units */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Grand Total Units</label>
                <span className="input-group-addon">$</span>
                <input type="text" className="form-control" onChange={this.handleGrandTotalUnitsChange.bind(this)} value={this.state.grandTotalUnits} placeholder='0.00'/>
              </div>
            </div>
            <hr/>
          </div>
          <div className='input-title-container'>
            ...
            <div className='field-input'>
              ...
              <div className="input-group financial-input">
                ...
                <input type="text" className="form-control" onChange={this.handleAvgEquityIntRateChange.bind(this)} value={this.state.avgEquityIntRate} placeholder='0'/>
                <span className="input-group-addon">%</span>
              </div>
              ...
              <div className="input-group financial-input">
                ...
                <input type="text" className="form-control" onChange={this.handleAvgFinancingIntRateChange.bind(this)} value={this.state.avgFinancingIntRate} placeholder='0'/>
                <span className="input-group-addon">%</span>
              </div>
              {/* Corporate Tax Rate */}
              <div className="input-group financial-input">
                <label className="input-group-addon financial-title">Corporate Tax Rate</label>
                <input type="text" className="form-control" onChange={this.handleCorporateTaxRateChange.bind(this)} value={this.state.corporateTaxRate} placeholder='0'/>
                <span className="input-group-addon">%</span>
              </div>
            </div>
            <hr/>
