...
export default class FinancialPerformanceSnapshot extends Component {
  constructor(props) {
    ...
    this.getMonthlyProfit = this.getMonthlyProfit.bind(this);
  }
  ...
  getMonthlyProfit() {
    if(!this.props.financialData) return "$0.00";
    else return `$${this.props.financialData.currentNetOpProfit()}`;
  }
  ...
  render() {
    ...
    <div className="fps-graph">
      <h4 className="pp-header text-center">Financial Performance Snapshot</h4>
